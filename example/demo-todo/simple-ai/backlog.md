...
[P0][done] Afficher la liste des tâches — sans ça l'app ne sert à rien ~2h =3h @epic:core
[P1][progress] Ajouter une tâche — l'utilisateur doit pouvoir créer une entrée ~1h @epic:core
[P1][done] Cocher une tâche comme faite — feedback de complétion, base de l'usage quotidien ~1h =0.5h @epic:core
